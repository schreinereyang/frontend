      ...
      <div className="text-white">
        {step === 0 && (
          <>
              ...
              {mockModels.map((m, i) => (
                <div key={i} className="bg-[#131b2c] p-4 rounded-xl border border-purple-700">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className={`text-sm ${m.active ? 'text-green-400' : 'text-red-400'}`}>{m.active ? 'Active' : 'Inactive'}</span>
                  </div>
            ...
            <div className="mt-10 text-center">
              <button onClick={() => setStep(1)} className="bg-purple-600 hover:bg-purple-700 text-white font-bold px-6 py-3 rounded shadow">
                ➕ Ajouter une modèle
              </button>
            </div>
          </>
        ...
        {step === 1 && (
          <div className="max-w-xl mx-auto">
            ...
            <p className="text-sm text-gray-400 mb-4">Connecte-toi manuellement à OnlyFans dans la fenêtre intégrée pour capturer les cookies.</p>
            ...
            <button onClick={() => setStep(2)} className="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded">
              ✅ Connexion terminée
            </button>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="max-w-xl mx-auto">
            ...
            />
            <button
              onClick={() => setMessage('✅ Modèle enregistré. ⚠️ L’IA ne sera pas activée tant que les infos minimales ne sont pas complètes.')}
